...
<div class="py-20 container">
	<div class="mx-auto max-w-2xl text-center">
		...
		<p class="text-base">
			Quanta offers flexible pricing plans for your needs. Choose from our range of affordable
		...
		<Tabs value="monthly" class="w-[320px] pt-4">
			<TabsList class="grid w-full grid-cols-2">
				...
				<a href="/pricing?interval=year" class="w-full">
					<TabsTrigger value="yearly" class="w-full">Yearly</TabsTrigger>
				</a>
			</TabsList>
		</Tabs>
	</div>
	<div
		class="isolate mx-auto mt-8 grid max-w-6xl grid-cols-1 justify-items-center gap-8 lg:grid-cols-3"
	>
