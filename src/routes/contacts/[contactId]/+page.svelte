      ...
      <Card class="max-w-sm">
        ...
        <CardContent class="flex flex-col space-y-4">
          <label class="space-y-2 w-full" for="name">
            <span>Name</span>
            <input type="text" name="name" bind:value={$form.name} class="w-full rounded-md py-1.5 px-4 bg-gray-300/30 focus:ring-2 focus:ring-gray-900 outline-none" />
            {#if $errors.name}
          ...
          <label class="space-y-2 w-full" for="email">
            <span>Email</span>
            <input type="email" name="email" bind:value={$form.email} class="w-full rounded-md py-1.5 px-4 bg-gray-300/30 focus:ring-2 focus:ring-gray-900 outline-none" />
            {#if $errors.email}
          ...
          <label class="space-y-2 w-full" for="phone">
            <span>Phone</span>
            <input type="text" name="phone" bind:value={$form.phone} class="w-full rounded-md py-1.5 px-4 bg-gray-300/30 focus:ring-2 focus:ring-gray-900 outline-none" />
            {#if $errors.phone}
          ...
          <label class="space-y-2 w-full" for="company">
            <span>Company</span>
            <input type="text" name="company" bind:value={$form.company} class="w-full rounded-md py-1.5 px-4 bg-gray-300/30 focus:ring-2 focus:ring-gray-900 outline-none" />
            {#if $errors.company}
