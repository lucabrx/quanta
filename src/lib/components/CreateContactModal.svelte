...
<form class="flex flex-col space-y-6" method="POST" action="?/createContact">
    <label class="space-y-2" for="name">
        <span>Name</span>
        <input class="w-full rounded-md py-1.5 px-4 bg-gray-300/30 focus:ring-2 focus:ring-gray-900 outline-none" type="text" name="name" bind:value={$form.name} />
        {#if $errors.name}
      ...
      <label class="space-y-2" for="email">
        <span>Email</span>
        <input class="w-full rounded-md py-1.5 px-4 bg-gray-300/30 focus:ring-2 focus:ring-gray-900 outline-none" type="email" name="email" bind:value={$form.email} />
        {#if $errors.email}
      ...
      <label class="space-y-2" for="phone">
        <span>Phone</span>
        <input class="w-full rounded-md py-1.5 px-4 bg-gray-300/30 focus:ring-2 focus:ring-gray-900 outline-none" type="text" name="phone" bind:value={$form.phone} />
        {#if $errors.phone}
      ...
      <label class="space-y-2" for="company">
        <span>Company</span>
        <input class="w-full rounded-md py-1.5 px-4 bg-gray-300/30 focus:ring-2 focus:ring-gray-900 outline-none" type="text" name="company" bind:value={$form.company} />
        {#if $errors.company}
